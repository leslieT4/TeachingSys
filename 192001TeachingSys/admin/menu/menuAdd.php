...
<body>
    ...
    <div class="usersetting">
	    <form method="post" name="" action="menuAddDeal.php" enctype="multipart/form-data">
            <table border="1" cellpadding="0" cellspacing="0">
			    <tr>
				    <td>菜单名:</td>
                    <td><input type="text" name="menu_name" style="font-size:16px;"></td>
			    </tr>
			    <tr>
				    <td>超级链接目的地:</td>
                    <td><input type="text" name="links" style="font-size:16px;"></td>
			    </tr>
			    <tr>
				    <td>备注:</td>
                    <td><input type="text" name="tips" style="font-size:16px;"></td>
			    </tr>
			    <tr>
				    <td>老师权限:</td>
